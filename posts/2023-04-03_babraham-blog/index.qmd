...
We all remember being told to show our working in school, usually in maths 🧮.
...
This has varying degrees of success...🤷🏼.![](https://imgs.xkcd.com/comics/standards.png)
...
Reproducing lab work 🧑🏼‍🔬 and computational work 🧑🏼‍💻 analogises quite well to cooking 🧑🏼‍🍳, a recipe is comprised of a list of ingredients (Data, Materials & Reagents), a set of steps to follow (Code, Protocols), and descriptions of the environment in which the food is cooked.
e.g.
...
Science can be like high stakes cooking (Think, a meal for diplomats from two countries with a tense relationship who also happen to be restaurant critics with a bunch of mutually incompatible food allergies and religious dietary restrictions) so the recipes have to be good, *really good* 😅.
...
|             |                                                                                                           |                                                                                                                   |                                                              |
|             | -   200g Plain Wheat Flour (all-purpose/550/55/0) ✅                                                      | -   [UKBi001-A](https://hpscreg.eu/about/naming-tool)                                                             | -   *Homo sapiens*                                           |
|             |                                                                                                           |                                                                                                                   |                                                              |
|             |                                                                                                           |                                                                                                                   |     (NCBI:txid9606) genome (Ensembl 109, GRCh38.p13 )        |
+-------------+-----------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+
| Process     | **Cooking Instructions**                                                                                  | **Protocols**                                                                                                     | **Code**                                                     |
|             |                                                                                                           |                                                                                                                   |                                                              |
|             | -   Bake at medium temperature until bronzed ❌ (vague)                                                   | -   Gel electrophoresis ❌ (vague)                                                                                | -   `random-scr ipt-from-email.R` ❌                         |
|             | -   Bake at 190℃ for 35mins if using a fan oven... ✅                                                     | -   Agarose gel electrophoresis (0.5%) TBE buffer, 120V, ethidium bromide, 10kb ladder from... ✅                 |                                                              |
|             |                                                                                                           |                                                                                                                   | -   `git` repository ✅                                      |
+-------------+-----------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+
| Environment | **Kitchen Conditions**                                                                                    | **Lab Environment**                                                                                               | **Compute Environment**                                      |
|             |                                                                                                           |                                                                                                                   |                                                              |
|             | -   Ambient temperature🌡, pressure🏔️, and humidity💧 (What's the boiling point of water in your kitchen?) | -   Ambient temperature🌡, pressure🏔️, and humidity💧 (What's the boiling point of water in your ~~kitchen~~ Lab?) | -   OS🐧/🪟/🍎                                               |
|             |                                                                                                           |                                                                                                                   |                                                              |
...
|             |                                                                                                           |                                                                                                                   |                                                              |
|             | -   Allergens 😵                                                                                          | -   Who: Steven Stickler (ORCID: 0000-1234-1234-1234) When: 2023-03-30 15:34 (UTC+0) ✅                           | -   When: commit: 954086fdf13d8...                           |
|             |                                                                                                           |                                                                                                                   |                                                              |
...
### Nice paper/grant you've got there 'be a shame if I couldn't publish/fund it, unless... 📏 (Stick)
