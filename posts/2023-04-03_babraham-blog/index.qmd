...
Fortunately there are tools of taking inventory of all the versions of all the tools that you've used, sharing this list and even re-creating the same computational environment from these inventories.
