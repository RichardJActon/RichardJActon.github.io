---
title: An intuitive explanation of inferential distance
description: "Explaining the concept of inferential distance, the distance between different beliefs in units of logical steps"
author: 
...
Beliefs B and C are predicated on belief A, beliefs D and E on belief B, and beliefs F and G on belief C. Thus belief A is need for beliefs B and C, belief B for D and E, and C for F and G. (see the [figure](inferencialDistance.png))

![](inferencialDistance.png)
...
**The Other:** That is just an unusually large fern.
**The One:** *sigh*
