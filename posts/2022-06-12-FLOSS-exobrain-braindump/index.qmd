...
description: "Free/libre and Open Source 'Exobrain' tools for notes, to do, task management etc."
author: 
...
![brain-1 icon by Servier https://smart.servier.com/ is licensed under CC-BY 3.0 Unported https://creativecommons.org/licenses/by/3.0/](brain-1.svg){width=180px}

LAST UPDATED: 2023-09-22 (see this files history in the [repo](https://gitlab.renkulab.io/racton/pan-narrans-blog/-/commits/master/posts/2022-06-12-FLOSS-exobrain-braindump))
...
- **Notes Apps**
	...
	- [focalboard](https://www.focalboard.com/) notion-like, same dev as mattermost
	- [appflowy](https://appflowy.io/) notion-like
	- [standard notes](https://standardnotes.com) notion-like, open? but with paid option that has annoying up-sells?
	- [notesnook](https://notesnook.com) went open not originally so, open server is in the roadmap - we'll see
	- [AFFiNE](https://affine.pro/) monday / notion-like, some interesting UI innovations, (MIT client, source available server)
	- [anytype](https://anytype.io/) - notion-like source available
	- [trilium](https://github.com/zadam/trilium/wiki) extensible scriptable ans customisable notes apps with md, freehand drawing, latex, mermaid etc.
	- [zettlr](https://zettlr.com) MD editor with Zotero integration pandoc document export.
	- [QownNotes](https://qownnotes.org) Simple MD notes with tagging in the QT framwork
	- Stylus / handwritten
	  - [Rnote](https://rnote.flxzt.net) good alternative to Xournal++ with cleaner UI great for stylus / handwritten notes
	  - [styluslabs](https://styluslabs.com) 
	- mind map
...
- Password / private key management
	...
	- **[keepass](https://keepass.info/)**
		- see [keepassxc](https://keepassxc.org/project/) for a better frontend
...
- Secure Messaging apps
	...
	- [Zulip](https://zulip.com/) - highly performant team chat app replacement for slack, teams etc.
	- [simpleX](https://simplex.chat/) - messenger with no fixed user ID and a decentralsied newtork
...
- Side note on Phone security
	- Phone security is particularly challenging right now, there are no truely good options which do not entail significant functionality compromise. Hardware wise nothing ideal exists, what would be desirable is a phone with hardware dip switches which physically disconnect the wi-fi/bluetooth, cellular modem, camera & microphone as well as having a removable battery, an eSIM and a re-lockable boot-loader. Many phones running a mainline linux kernel still lack or have buggy basic functionality though android app emulation options are improving with the waydroid project.
		- [GrapheneOS](https://grapheneos.org/) probably the best secure degoogled android option, limited to google pixel hardward for the secure bootloader functionality, good profiles system that will allow you to install google play services if you need it but with limited privledges instead of their default system level access
