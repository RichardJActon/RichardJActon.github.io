...
- **Notes Apps**
	...
	- [focalboard](https://www.focalboard.com/) notion-like
	...
	- [notesnook](https://notesnook.com) went open not originally so, not sure if server is? 
	- [AFFiNE](https://affine.pro/) notion-like, some interesting UI innovations
